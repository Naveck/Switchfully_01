...
public class MethodsCodelab08 {
    ...
    private static int increment(int toInc) {
        int incremented = toInc + 1;
        System.out.println("Value " + toInc + " incremented by 1. New value is " + incremented);
        return incremented;
